...
pgrep -x rx_exe  > /dev/null && echo -e  "rx_exe found" || (echo -e "rx_exe not found" && ../executable/rx_exe ${arr[4]} ${arr[5]}> /dev/null&)
pgrep -x WS_exe > /dev/null  && echo -e  "WS_exe found" || (echo -e "WS_exe not found" && ../executable/WS_exe ${arr[6]} ${arr[7]} >/dev/null&)
